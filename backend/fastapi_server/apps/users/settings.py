...
SETTINGS = {
    ...
    "ACCESS_TOKEN_VIA_COOKIE": os.getenv("USERS_ACCESS_TOKEN_VIA_COOKIE") == "1",
    "ACCESS_TOKEN_COOKIE_SECURE": os.getenv("USERS_ACCESS_TOKEN_COOKIE_SECURE") == "1",
    "ACCESS_TOKEN_COOKIE_SAME_SITE": os.getenv(
        "USERS_ACCESS_TOKEN_COOKIE_SAME_SITE", "lax"
    ),
    "ACCESS_TOKEN_COOKIE_DELETE_ON_LOGOUT": os.getenv(
        "USERS_ACCESS_TOKEN_COOKIE_DELETE_ON_LOGOUT"
    )
    == "1",
